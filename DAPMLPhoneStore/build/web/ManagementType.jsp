                ...
                <div class="content">
                    ...
                    <jsp:include page="component/manager/navbar.jsp"></jsp:include>
                        ...
                        <div class="container pt-4 px-4">
                            <div class="card">
                                <div class="card-body">
                                    <a class="btn btn-primary" href="AddTypePage.jsp">Add Type</a>
                                                ...
                                                <td class="text-end">
                                                    <c:choose>
                                                        <c:when test="${p.isStatus() == 'true'}">
                                                            <a href="DeleteType?id=${p.getType_id()}&status=0"><button style="margin: 1px" class="btn btn-danger">Delete</button></a>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <a href="DeleteType?id=${p.getType_id()}&status=1"><button style="margin: 1px" class="btn btn-success">Active</button></a>
                                                        </c:otherwise>
                                                    </c:choose>
                                                    <a href="UpdateType?id=${p.getType_id()}"><button style="margin: 1px" class="btn btn-primary">Update</button></a>
                                ...
                                <c:set var="pagination_url" value="${pageContext.request.contextPath}/ManagementType?" scope="request"></c:set>
