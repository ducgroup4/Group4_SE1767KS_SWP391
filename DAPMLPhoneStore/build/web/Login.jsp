                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="contact.html">Guarantee</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="contact.html"><i class="fa fa-shopping-cart"></i> Cart</a>
                            </li>
                            <li class="nav-item">
                                            ...
                                            <div class="mb-md-5 mt-md-4 pb-5">
                                                ...
                                                <div class="form-white mb-4">
                                                    ...
                                                    <div style="display: flex" class="form-white mb-4">
                                                        ...
                                                        <i style="position: absolute; right: 60px; bottom:380px; color: black" class="fa-solid fa-eye" onclick="showhideenPass(event)"></i>
