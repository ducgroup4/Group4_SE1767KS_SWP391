...
<html>
    ...
    <body>
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="AddNews" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="editor" class="md-textarea form-control" rows="3">${requestScope.product.getDescription()}</textarea>
                        </div>
                        <br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select required name="news_type" class="form-select">
                                <c:forEach items="${sessionScope.news_type}" var="b">
                                    <option value="${b.getNews_type_id()}">${b.getType_name()}</option> 
                                </c:forEach>
                            </select>
                        </div>
                        <br>
                        <div class="form-group">
                            ...
                            <input required="" name="photo" accept="image/*" class="form-control" type="file" id="formFileMultiple" />
                        </div>
        ...
        <script>
            ...
            function AddProductFrmSubmit() {
                document.getElementById("AddProductFrm").submit()
            }
