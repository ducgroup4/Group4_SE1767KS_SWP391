...
//        String recipient = "recipient@gmail.com"; // Change to the recipient's email address
        final String sender = "group3compstore@gmail.com"; // Change to your Gmail address
        final String password = "knby kbjp gits zdxh"; // Change to the app password generated in Step 2
