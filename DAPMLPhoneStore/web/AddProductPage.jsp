                                ...
                                <div class="card">
                                    ...
                                    <form class="form-group" method="post" id="AddProductFrm" action="AddProduct" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label class="form-label font-weight-bold" for="formControlLg">Product Name</label>
                                            <input required name="name"  type="text" id="formControlLg" class="form-control" />
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label font-weight-bold" for="formControlLg">Price</label>
                                            <input id="numberInput" type="text" class="form-control" value="" name="price" oninput="formatNumber(this)">
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label class="form-label font-weight-bold" for="formControlLg">Sale</label>
                                            <input required name="sale" type="number"  id="formControlLg" class="form-control" />

                                        </div>
                                        <div class="form-group">
                                            <label class="form-label font-weight-bold" for="formControlLg">Color</label>
                                            <input required name="color" type="text" id="formControlLg" class="form-control" />
                                        ...
                                        <label class="form-label font-weight-bold select-label mt-3">Brand</label>
                                        ...
                                        <label class="form-label font-weight-bold select-label">Type</label>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label font-weight-bold" for="formControlLg">Guarantee Time</label>
                                            <input required name="guarantee"  type="number" id="formControlLg" class="form-control" />

                                        </div>
                                        <div class="form-group">
                                            <label for="formFileMultiple" class="form-label font-weight-bold">Images</label>
                                            <input required name="photo" accept="image/*" class="form-control" type="file" id="formFileMultiple" multiple />
                                        </div>
